...
public class Bank implements TribeDeletedListener{
	...
	private String listOfDescriptionsPop[] = {"Leur connaissance du terrain leur permet d'etre plus efficaces pour se defendre. Il faut une unite de plus pour les attaquer.", 
			...
			"Leur envie de s'etablir sur un ordinateur est tellement grande que leur combativité en est stimulee, ils ont besoin d'une unite en moins pour attaquer les salles GI" , 
			"Leur charme absolu leur permet de rendre inutile 1 defenseur du terrain attaqué."
			,"Leur rapidite à juger leurs ennemis leur permet de se replier rapidement, ils ne perdent pas de troupe quand ils se font envahir."
			...
			,"Leurs examens pour devenir soldats sont tellement eprouvants qu'une unite est reorientee à chaque tour."
			...
			,"Il faut 1 unite en + pour pouvoir les attaquer étant donnée leur violence sans égal"
			,"Etant dotés d'un pass tres efficace, ils peuvent s'établir n'importe ou"};
	...
	private String listOfDescriptionsPower[] = {"+1 point de victoire bonus si installés dans la bibliothèque",
			...
			," A  chaque tour, reçoivent une unité bonus"
			,"+ 7 points lorsque la tribu est choisie"
			,"ont besoin de 1 troupes en moins pour attaquer"
			,"resistants au attaques, 1 unitÃ©s adverse supplementaire est necessaire pour les attaquer"
			,"leurs attaques sournoises leurs permettent de ne pas cÃ©der de terrain dans les couloirs"
	...
	public Bank(){
		...
		//crÃ©ation de la liste de la banque contenant les diffÃ©rents pouvoirs et leurs caractÃ©ristiques (population en + et description)
		...
		//crÃ©ation de la liste de la banque contenant les diffÃ©rents peuples et leurs caractÃ©ristiques (population en + et description)
