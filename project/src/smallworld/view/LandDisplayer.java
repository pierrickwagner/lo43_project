...
public class LandDisplayer {
    ...
    public LandDisplayer(JPanel panelLand, JPanel labelLand, Land land,HashMap<Population.TypePopulation, ImageIcon> collection) {
		...
		labNumberOfTroups = new JLabel("nombre d'unit�s dessus!");
	...
	public void update()
    {
    	...
    	if(land.getOccupant()!=null){
    		...
    		ImageIcon icon = new ImageIcon(new ImageIcon("./image_peuple/DEFAULT.jpg").getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT));
    		gif.setIcon(icon);
