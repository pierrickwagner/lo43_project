...
public class MyWindow extends javax.swing.JFrame implements TribeDeletedListener{
    ...
    private void finishTurn()
    {
        ...
        for(LandDisplayer ld : landDisplayer)
        {
         ...
         //TODO Ã  complÃ©ter pour toujours afficher les bons boutons, et les scores si la partie est finie
    ...
    //Ajoute un listener à chaque land
...
//        label27.setText("1");
        ...
        buttonPasserDeclin.setText("Passer en dÃ©clin");
